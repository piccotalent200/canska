...
import CanskaNQuad from './sections/CanskaNQuad';
    ...
    return (
        <div className='font-dm'>
            ...
            <div className="w-full" ref={tabsRef}>
                ...
                >
                    <Tabs.Item active={activeTab === 0} title={renderTabTitle("01", "Canska & Quad", 0)}>
                       <CanskaNQuad />
                    </Tabs.Item>

                    <Tabs.Item active={activeTab === 1} title={renderTabTitle("02", "User Account", 1)}>
                       <UserAccount/>
                    </Tabs.Item>

                    <Tabs.Item active={activeTab === 2} title={renderTabTitle("03", "Privacy Policy", 2)}>
                       <PrivacyPolicy/>
                    </Tabs.Item>
