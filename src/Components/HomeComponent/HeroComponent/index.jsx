...
const HeroComponent = () => {
    ...
    return (
        ...
        <section ref={containerRef} className='p-[40px_16px] lg:p-[56px_56px_250px_56px] bg-[url("/img/hero-bg.svg")] bg-cover bg-center' >
                ...
                >
                    <ScrollAnimatedElement delay={0.2}>
                        <ul className="ps-[32px]">
                            <li className="text-[24px] leading-[38px] lg:text-[28px] lg:leading-[40px] xl:text-[32px] xl:leading-[46px] font-medium text-[#111827] list-disc">
