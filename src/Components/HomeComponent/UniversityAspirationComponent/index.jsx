...
const UniversityAspirationComponent = () => {

    return (
        <div className='bg-[#0F172A] p-[40px_16px] lg:p-[10px_56px_80px] !delay-0'>

            <div className='relative lg:-top-[130px] bg-white shadow-[0px_4px_24px_0px_#00000029] rounded-[10px] p-[40px_16px] lg:p-[40px_32px] xl:p-[48px_56px_56px_56px] max-lg:mb-[40px]'>
            ...
            <ScrollAnimatedElement>
                <input type="text" placeholder='e.g. Ages 3 to 19' className='outline-none border border-solid border-[#2B3958] rounded-[8px] bg-[#161F35] text-base leading-[20px] font-normal placeholder:text-[#4A546D] text-[#DBBCFB] p-[16px_28px] block w-full max-w-[502px] mx-auto mb-[40px]' />
            </ScrollAnimatedElement>

            <ScrollAnimatedElement className='flex max-sm:flex-col gap-[16px] sm:gap-[32px] items-center justify-center'>
                <a href="" className='border border-solid border-[#DBBCFB] rounded p-[14px_16px] text-base leading-[20px] font-normal text-[#DBBCFB] block sm:w-fit w-full text-center transition-all duration-300 hover:bg-[#DBBCFB] hover:text-[#0F172A]'>
...
export default UniversityAspirationComponent