  ...
  return (
    <>
      <div className="w-full min-h-screen bg-[#5E17EB] flex flex-col items-center justify-center font-dm select-none">
        ...
        <div
          className="w-full max-w-[1096px] bg-white shadow-[5px_4px_4px_4px_#0000001A] rounded-[24px] overflow-hidden grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] grow">
          {/* Left Hand Column: Hero Image (2011 2) */}
          ...
          <div className="w-full h-full flex flex-col justify-between text-left">
                ...
                <form className="space-y-[24px]">
                  ...
                  <div className="flex flex-col space-y-[8px]">
                    ...
                    <input
                      ...
                      className="w-full h-[46px] px-4 bg-white border border-[#6F2DAE66] rounded-xl outline-hidden hover:border-[#6F2DAE] focus:border-[#6F2DAE] focus:shadow-[0px_1px_2px_2px_#0000000D] text-sm leading-[18px] font-normal placeholder:text-[#9CA3AF] transition-all duration-300"
                    />
                  </div>
            ...
            <div className=" bg-[#F6F1E7] p-[20px_16px] sm:p-[20px_25px]">
              ...
              <p className="text-[12px] leading-[20px] font-normal text-[#0A0A0A]">
                Enter your username and password precisely as created, including
                correct letter case, numbers, and special characters. For
                security, the system uses progressive lockouts. After five
                failed login attempts, access is temporarily locked for thirty
                minutes, followed by longer lockouts for repetitive failures.
                Multi factor authentication is required using an authenticator
                app, registered devices, or backup codes. If access is lost,
                account recovery is available through verified email, phone, or
                identity checks. Recovery requests may include a security
                review. All login and recovery activity is logged for
                protection.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-[16px] justify-between p-[30px_64px] border-t border-solid border-[#D9D9D9]/50 w-full">
            <p className="text-xs leading-[18px] font-normal text-[#FFFFFFCC]">© 2026 Canska Education Services Pvt. Ltd. All Rights Reserved.</p>

            <ul className="flex gap-[20px] items-center">
                <li>
                    <a href="" className="text-xs leading-[18px] font-normal text-[#FFFFFFCC] hover:text-white">Privacy</a>
                </li>
                  <li>
                    <a href="" className="text-xs leading-[18px] font-normal text-[#FFFFFFCC] hover:text-white">Terms</a>
                </li>
            </ul>
        </div>
      </div>
