...
const DesktopMenu = ({ menuTitle, menuData, onMouseEnter, onMouseLeave }) => {
  return (
            ...
            <div key={index}>
              {section.title && (
                <div className='p-[32px_64px_56px_16px]'>
                  ...
                  {section.cta && (
                    <a href="" className='text-base leading-[20px] font-medium text-[#FFFFFF] bg-[#5E17EB] p-[12px_24px] uppercase sansFlex block hover:bg-[#4300c9] transition-all duration-200 w-fit'>
                      {section.cta}
                    </a>
                  )}
                </div>
                  ...
                  <ul className='mt-[8px] group/links'>
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex} className="last:mb-0 group/link">
                        <div>
                          <a href="" className="text-[24px] leading-[30px] font-normal text-[#5E17EB] hover:bg-[#EBE1FF] p-[8px_64px_8px_16px] flex items-center justify-between transition-all duration-200 group-hover/link:bg-[#EBE1FF] sansFlex">
