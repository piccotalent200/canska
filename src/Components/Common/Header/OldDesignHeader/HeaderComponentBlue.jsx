...
const HeaderComponentBlue = () => {
  ...
  const renderDesktopMenu = (menuTitle, menuData) => (
    <Popover className="relative">
      <PopoverButton className='text-base leading-[22px] text-[#FFFFFF] font-medium flex items-center gap-[4px] cursor-pointer [&[aria-expanded="true"]>img]:rotate-[180deg] outline-none [&[aria-expanded="true"]]:font-merienda'>
        <span>{menuTitle}</span>
        <Image src="/img/dropdown-arrow-white.svg" alt="arrow" width={16} height={16} className='transition-all duration-200' />
      </PopoverButton>
  ...
  return (
    <>
      <header className='overflow-hidden flex items-center bg-[#7F00FF] h-[80px] sticky top-0 z-[100] px-[32px]'>
        <div className='pe-[16px] xl:pe-[32px]'>
          <a href="" className='cursor-pointer'>
            <Image src="/img/canska-white.svg" alt="" width={120} height={32} />
          </a>
        </div>
        ...
        <div className='flex items-stretch ms-auto max-[1050px]:hidden'>
          <a href="" className='h-full p-[29px_16px] xl:p-[29px_32px] text-base leading-[22px] font-medium text-[#ffffff] border-s border-solid border-[#C4BEE9] transition-all duration-200 hover:bg-[#0A011214] block'>
            Create Account
          </a>
          <a href="" className='h-full p-[29px_16px] xl:p-[29px_32px] text-base leading-[22px] font-medium text-[#ffffff] border-s border-solid border-[#C4BEE9] transition-all duration-200 hover:bg-[#0A011214] block'>
            Apply to The Quad
        ...
        >
          <span className={`block w-6 h-0.5 bg-[#ffffff] transition-all duration-300 `}></span>
          <span className={`block w-6 h-0.5 bg-[#ffffff] transition-all duration-300 `}></span>
          <span className={`block w-6 h-0.5 bg-[#ffffff] transition-all duration-300 `}></span>
        </button>
      </header>
                    ...
                    {Object.entries(menuData).map(([menuTitle, data]) => (
                      <div key={menuTitle} className="border-b border-[#CAC2DE]">
                        ...
                        <div className={`overflow-hidden transition-all duration-300 ${
                          activeSubmenu === menuTitle ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'
                        }`}>
