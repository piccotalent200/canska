            ...
            <img
              ...
              onError={(e) => {
                ...
                e.currentTarget.innerHTML = `
                  <div className="w-16 h-16 bg-[#5E17EB]/10 rounded-full flex items-center justify-center text-[#5E17EB]">
                    <svg className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
                  </div>
                `;
              }}
            />
